...
//	glBindTexture(GL_TEXTURE_2D, textureID);
//	glTexEnvi(GL_TEXTURE_ENV, GL_TEXTURE_ENV_MODE, GL_MODULATE);
//	gluBuild2DMipmaps(GL_TEXTURE_2D, GL_RGB, w, h, GL_RGB, GL_UNSIGNED_BYTE, rgbData);
...
//}
//
//static void drawRing(float innerR, float outerR, int slices)
//{
...
//void drawWaferCone()
//{
//	GLfloat spec[] = { 0.05f, 0.03f, 0.02f, 1.0f };
...
//	drawTexturedSphere(0.22f, 32, 32, iceCreamTexture1);
//	glPopMatrix();
//
//	glColor3f(1.0f, 1.0f, 1.0f);
//	glPushMatrix();
//	glTranslatef(0.01f, 0.6f, 0.01f);
//	glScalef(1.02f, 0.96f, 1.02f);
//	drawTexturedSphere(0.2f, 32, 32, iceCreamTexture2);
//	glPopMatrix();
//
//	glPopMatrix();
//}
...
//	glRotatef(rotationAngle, 0.0f, 1.0f, 0.0f);
//
//	GLfloat cherrySpec[] = { 0.8f, 0.2f, 0.2f, 1.0f };
//	glMaterialfv(GL_FRONT, GL_SPECULAR, cherrySpec);
...
//	drawCylinder(0.005f, 0.005f, 0.07f, 6, 2);
//	glPopMatrix();
//
